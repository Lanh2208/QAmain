...
if __name__ == '__main__':
    ...
    # read all the data and store it . doc tat ca du lieu va luu tru
    ...
    # get the closest docs for each question. nhan tai lieu gan nhat cho moi cau hoi
    ...
    # define processes xac dinh quy trinh
    ...
    # compute the scores for each pair, and print the statistics . tinh toan so diem cho tung cap  in thong ke
